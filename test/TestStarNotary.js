...
it('can add the star name and star symbol properly', async() => {
    ...
    let tokenId = 6;
    let instance = await StarNotary.deployed();
    await instance.createStar('Test 6 Star!', tokenId, {from: accounts[0]});
    const name = await instance.name.call();
    const symbol = await instance.symbol.call();
    const result = name === 'Rutu Token' && symbol === 'RUT';
...
it('lets 2 users exchange stars', async() => {
    ...
    let instance = await StarNotary.deployed();
    await instance.createStar('Test 7 Star!', tokenId1, {from: user1});
    await instance.createStar('Test 8 Star!', tokenId2, {from: user2});
